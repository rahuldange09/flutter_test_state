...
import 'package:test_state/routes.dart';
              ...
              LayoutBuilder(
                builder: (context, _) => RaisedButton(
                  ...
                  onPressed: () => Navigator.of(context)
                      .pushNamed(RouteGenerater.ROUTE_DUMMY),
                ),
              ),
            ],
          ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RaisedButton(
        child: Text("Onwards"),
        onPressed: () =>
            Navigator.of(context).pushNamed(RouteGenerater.ROUTE_NESTED),
      ),
    );
  }
}
...
class NestedState extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
        child: Text('Restored from state: '),
      ),
    );
  }
}
